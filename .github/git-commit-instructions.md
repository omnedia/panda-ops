...
When squashing commits during a pull request merge, generate a single commit message that summarizes the overall change and still follows the Conventional Commits format.
